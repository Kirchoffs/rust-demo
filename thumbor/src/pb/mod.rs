...
mod abi;
pub use abi::ImageSpec;
pub use abi::Spec;
pub use abi::spec;
pub use abi::{Resize, Crop, Fliph, Flipv, Contrast, Filter, Watermark};
pub use abi::{resize, filter};
...
#[cfg(test)]
mod tests {
    use super::{Spec, ImageSpec};
    use super::{filter, resize};
